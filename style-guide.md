...
| Token       | HSL                | HEX         |
| ----------- | ------------------ | ----------- |
| Neutral 900 | hsl(243, 96%, 9%)  | **#060325** |
| Neutral 800 | hsl(243, 27%, 20%) | **#2A2742** |
| Neutral 700 | hsl(243, 23%, 24%) | **#332F4B** |
| Neutral 600 | hsl(243, 23%, 30%) | **#403B5B** |
| Neutral 300 | hsl(240, 6%, 70%)  | **#B1B1B8** |
| Neutral 200 | hsl(250, 6%, 84%)  | **#D6D5DB** |
| Neutral 0   | hsl(0, 0%, 100%)   | **#FFFFFF** |

| Token      | HSL                | HEX         |
| ---------- | ------------------ | ----------- |
| Orange 500 | hsl(28, 100%, 52%) | **#FF8C28** |


| Token    | HSL                | HEX         |
| -------- | ------------------ | ----------- |
| Blue 500 | hsl(233, 67%, 56%) | **#4D5DF0** |
| Blue 700 | hsl(248, 70%, 36%) | **#3B21A3** |
